    ...
    <section class="techniques">
      ...
      <div class="panel-group" id="techniques-accordion">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title">
              <a data-parent="#techniques-accordion" data-toggle="collapse" href="#techniques-consolidate">
                Consolidate
              </a>
            </h4>
          </div>
          <div id="techniques-consolidate" class="panel-collapse collapse">
            <div class="panel-body">
              <section class="technique-info">
                <section class="about">
                  <h5>What</h5>
                  <p>When you’re done editing several regions, it may be helpful to group them so you can move and manipulate them together. You can <strong>merge</strong> and create a new, consolidated audio file from the regions.</p>
                </section>
                <section class="tips">
                  <h5>Tips</h5>
                  <p>Warning! Merging is <strong>destructive</strong> editing, resulting in new audio files.</p>
                </section>
              </section>
              <section class="how">
                <h5>How</h5>
                <iframe width="560" height="315" src="//www.youtube.com/embed/B6WLdeTDJ3A" frameborder="0" allowfullscreen></iframe>
              </section>
            </div>
          </div>
        </div>
